...
contextBridge.exposeInMainWorld("zoniq", {
  ...
  exportScenarios: (opts) => ipcRenderer.invoke("export-scenarios", opts),
  importScenarios: () => ipcRenderer.invoke("import-scenarios"),
  confirmImportScenarios: (opts) => ipcRenderer.invoke("confirm-import-scenarios", opts),
